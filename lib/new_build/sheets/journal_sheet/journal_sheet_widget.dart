...
import 'journal_sheet_model.dart';
export 'journal_sheet_model.dart';

class JournalSheetWidget extends StatefulWidget {
  const JournalSheetWidget({super.key});

  @override
  State<JournalSheetWidget> createState() => _JournalSheetWidgetState();
}

class _JournalSheetWidgetState extends State<JournalSheetWidget> {
  late JournalSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JournalSheetModel());
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '34wigjle' /* Your answers help create perso... */,
                                          ),
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '0pi0hw8b' /* Complete the onboarding proces... */,
                                                  ),
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return wrapWithModel(
                                                    ...
                                                    child: JornalListItemWidget(
                                                      key: Key(
                                                        'Key702_${listViewIndex.toString()}',
                                                      ),
                                                      question:
