...
class _NotificationSettingsWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.settings = _model.currentUser?.notificationSettings;
      safeSetState(() {});
      if (_model.settings?.startTime == null) {
        _model.settings = NotificationSettingsStruct(
          startTime: DateTime.fromMicrosecondsSinceEpoch(1764234000000000),
          endTime: DateTime.fromMicrosecondsSinceEpoch(1764262800000000),
          messagePerDay: 3,
          selectedCategories:
              _model.currentUser?.notificationSettings.selectedCategories,
        );
        safeSetState(() {});
      }
    });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'c9aignu8' /* Small doses of motivation can ... */,
                        ),
                        textAlign: TextAlign.center,
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      HapticFeedback.lightImpact();
                                      if (_model.settings!.messagePerDay > 1) {
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      _model.updateSettingsStruct(
                                        (e) =>
                                            e..startTime = _model.datePicked1,
                                      );
                                      safeSetState(() {});
                                    },
                                    child: Container(
              ...
              child: Padding(
                ...
                child: wrapWithModel(
                  ...
                  child: NextButtonWidget(
                    title: 'Allow and save',
                    onTab: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        notificationSettings: updateNotificationSettingsStruct(
                          _model.settings,
