...
class _WallWidgetState extends State<WallWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WallModel());
  }
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '4utwlnjy' /* Become brings you your daily d... */,
                        ),
                                        ...
                                        child: Visibility(
                                          ...
                                          child: Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'qjntpj70' /* Click here to subscribe to Bec... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                    ...
                                    if (revenue_cat
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '3zv3n5xt' /* You've subscribed to Become Pr... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
